    ...
    return (
        <div className={styles.container}>
            <div className={styles.contentPane}>
                ...
                <div className={styles.launchingMeetingLabel}>{t(`${_TNS}.titleNew`)}</div>
                ...
                <div className={styles.descriptionLabel}>
                    {t(`${_TNS}.noDesktopApp`)} &nbsp;
                    <a href={generateDownloadURL()}>{t(`${_TNS}.downloadApp`)}</a>
                </div>
                <div className={styles.buttonsContainer}>
                    <Button label={t(`${_TNS}.tryAgainButton`)} onClick={onTryAgain} />
                    {isSupportedBrowser() && (
                        <Button
